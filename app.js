...
var Couch, DOCTAPE_APP_KEY, DOCTAPE_APP_SECRET, Doctape, DoctapeStrategy, all, app, db, ensureAuthenticated, express, getAllGalleryData, getGalleries, http, member, passport, path, request, server;
